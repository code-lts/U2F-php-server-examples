 ...
 * @return {Object}
 */
u2f.WrappedChromeRuntimePort_.prototype.formatSignRequest_ = function (signRequests, timeoutSeconds, reqId) {
        return {
            type: u2f.MessageTypes.U2F_SIGN_REQUEST,
 ...
 * @return {Object}
 */
u2f.WrappedChromeRuntimePort_.prototype.formatRegisterRequest_ = function (signRequests, registerRequests, timeoutSeconds, reqId) {
        return {
 ...
 */
u2f.WrappedAuthenticatorPort_.prototype.doResponseFixups_ = function (responseObject) {
 ...
 * @return {string}
 */
u2f.WrappedAuthenticatorPort_.prototype.formatSignRequest_ = function (signRequests, timeoutSeconds, reqId) {
    if (!signRequests || signRequests.length == 0) {
        ...
        var intentUrl = u2f.WrappedAuthenticatorPort_.INTENT_URL_BASE_ + ';S.appId=' + encodeURIComponent(appId) + ';S.eventId=' + reqId + ';S.challenges=' + encodeURIComponent(
            JSON.stringify(this.getBrowserDataList_(signRequests))
        ) + ';end';
        return intentUrl;
};
 ...
 * @return {Object}
 */
u2f.WrappedAuthenticatorPort_.prototype.formatRegisterRequest_ = function (signRequests, enrollChallenges, timeoutSeconds, reqId) {
    ...
    if (signRequests) {
        ...
        var intentUrl = u2f.WrappedAuthenticatorPort_.INTENT_URL_BASE_ + ';S.request=' + encodeURIComponent(JSON.stringify(request)) + ';end';
